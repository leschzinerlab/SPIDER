...
echo "! "
/opt/qb3/imagic-110326/openmpi/bin/mpirun -np 4 -x IMAGIC_BATCH  /opt/qb3/imagic-110326/incore/incprep.e_mpi <<EOF
YES
4
$dir/grp00$i/part
$dir/grp00$i/part_prep
0.05
0.005
0.8
0.6,0.2
...
echo "! "
/opt/qb3/imagic-110326/openmpi/bin/mpirun -np 8 -x IMAGIC_BATCH  /opt/qb3/imagic-110326/msa/msa.e_mpi <<EOF
YES
8
NO
FRESH_MSA
...
echo "! "
/opt/qb3/imagic-110326/msa/classify.e <<EOF
IMAGES/VOLUMES
$dir/grp00$i/part_prep
0
$numEIGEN
...
echo "! "
/opt/qb3/imagic-110326/msa/classum.e <<EOF
$dir/grp00$i/part_prep
$dir/grp00$i/classes
